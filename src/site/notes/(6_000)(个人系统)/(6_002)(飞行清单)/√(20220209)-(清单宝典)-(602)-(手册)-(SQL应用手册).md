...
5. SP_EXECUTESQL
    1. [[√(20220917)-(语句学习)-(000)-(NP)-(EXEC与EXEC SP_EXECUTESQL的用法及比较)|EXEC与EXEC SP_EXECUTESQL的用法及比较]]
...
64. 存储过程——20220917——(07-表列)索引复制现有表——[[√(20220917)-(过程解析)-(000)-(数仓)-(索引复制现有表-P_INDEX_CLONE)|P_INDEX_CLONE]]
